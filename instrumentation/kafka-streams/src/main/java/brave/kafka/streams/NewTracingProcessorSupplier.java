...
class NewTracingProcessorSupplier<KIn, VIn, KOut, VOut> implements ProcessorSupplier<KIn, VIn, KOut, VOut> {
  final KafkaStreamsTracing kafkaStreamsTracing;
  final String spanName;
  final ProcessorSupplier<KIn, VIn, KOut, VOut> delegateProcessorSupplier;

  NewTracingProcessorSupplier(KafkaStreamsTracing kafkaStreamsTracing,
                              String spanName,
  ...
  @Override public Processor<KIn, VIn, KOut, VOut> get() {
    return new NewTracingProcessor<>(kafkaStreamsTracing, spanName, delegateProcessorSupplier.get());
  }
}
