...
final class TracingTopicSession extends TracingSession<TopicSession> implements TopicSession {
  ...
  @Override public TopicSubscriber createSubscriber(Topic topic) throws JMSException {
    return TracingTopicSubscriber.create(delegate.createSubscriber(topic), jmsTracing);
  }

  @Override
  public TopicSubscriber createSubscriber(Topic topic, String messageSelector, boolean noLocal)
      throws JMSException {
    return TracingTopicSubscriber.create(delegate.createSubscriber(topic, messageSelector, noLocal),
        jmsTracing);
  }

  @Override public TopicPublisher createPublisher(Topic topic) throws JMSException {
    return TracingTopicPublisher.create(delegate.createPublisher(topic), jmsTracing);
  }
}
